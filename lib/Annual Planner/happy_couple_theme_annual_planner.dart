...
class HappyCoupleThemeCalendarApp extends StatefulWidget {
  const HappyCoupleThemeCalendarApp({super.key});
...
class _HappyCoupleThemeCalendarAppState
  ...
  Future<void> _saveDates() async {
    try {
      ...
      await prefs.setString('happy_couple_calendar_theme_2025', jsonData);
    } catch (e) {
  ...
  Future<void> _loadSavedDates() async {
    try {
      ...
      final String? savedData =
          prefs.getString('happy_couple_calendar_theme_2025');
  ...
  Future<void> _takeScreenshotAndShare() async {
    try {
      ...
      final imagePath =
          '${directory.path}/happy_couple_theme_calendar_2025.png';
